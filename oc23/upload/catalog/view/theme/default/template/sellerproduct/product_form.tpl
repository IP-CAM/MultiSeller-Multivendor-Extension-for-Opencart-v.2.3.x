          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <ul class="nav nav-tabs" id="languagetab">
                ...
                <li><a href="#languagetab<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="admin/language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
            ...
            <div class="tab-pane" id="tab-data">
             <?php if($config_multiseller_image){ ?>
              ...
              <?php }else{ ?>
                <input type="hidden" type="text" name="sku" value="<?php echo $sku; ?>" />
              <?php } ?>
              ...
              <?php }else{ ?>
                <input type="hidden" type="text" name="upc" value="<?php echo $upc; ?>" />
              <?php } ?>
              ...
              <?php }else{ ?>
                <input type="hidden" type="text" name="ean" value="<?php echo $ean; ?>"  />
              <?php } ?>
              ...
              <?php }else{ ?>
                <input type="hidden" type="text" name="jan" value="<?php echo $jan; ?>" />
              <?php } ?>
              ...
              <?php }else{ ?>
                <input type="hidden" type="text" name="isbn" value="<?php echo $isbn; ?>"  />
              <?php } ?>
              ...
              <?php }else{ ?>
                <input type="hidden" type="text" name="mpn" value="<?php echo $mpn; ?>" />
              <?php } ?>
              ...
              <?php }else{ ?>
                <select name="tax_class_id" id="input-tax-class" class="form-control" style="display: none;">
                <option value="<?php echo $tax_class_id; ?>" selected="selected"></option>
              </select>
              ...
              <?php }else{ ?>
                <input type="hidden" type="text" name="minimum" value="<?php echo $minimum; ?>" />
              <?php } ?>
              ...
              <?php }else{ ?>
                <select name="stock_status_id" id="input-subtract" class="form-control" style="display: none;">
                  <option value="<?php echo $stock_status_id; ?>" selected="selected"></option>
                </select>
              <?php } ?>
              ...
              <?php }else{ ?>
                <?php if ($shipping) { ?>
                <input type="hidden" type="radio" name="shipping" value="1" checked="checked" />
                <?php } else { ?>
                  <input type="hidden" type="radio" name="shipping" value="0" checked="checked" />
                <?php } ?>
              <?php } ?>
              ...
              <?php }else{ ?>
                <input type="hidden" type="text" name="keyword" value="<?php echo $keyword; ?>" />
              <?php } ?>
              ...
              <?php }else{ ?>
              <input type="hidden" type="text" name="date_available" value="<?php echo $date_available; ?>" placeholder="" data-date-format="YYYY-MM-DD" id="input-date-available" class="form-control" />
              <?php } ?>
              ...
              <?php }else{ ?>
                <input type="hidden" type="text" name="sort_order" value="<?php echo $sort_order; ?>" />
            <?php } ?>
            </div>
            <div class="tab-pane" id="tab-links">
              ...
              <?php }else{ ?>
                <input type="hidden" type="text" name="manufacturer_id" value="<?php echo $manufacturer_id; ?>" />
              <?php } ?>
                      ...
                      <div class="table-responsive">
                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                          ...
                          <tfoot>
                            <tr>
                              <td colspan="6"></td>
                              <td class="text-left"><button type="button" onclick="addOptionValue('<?php echo $option_row; ?>');" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                            </tr>
                          </tfoot>
                        </table>
                      </div>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="2"></td>
                      <td class="text-left"><button type="button" onclick="addRecurring()" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                    </tr>
                  </tfoot>
                </table>
              </div>
