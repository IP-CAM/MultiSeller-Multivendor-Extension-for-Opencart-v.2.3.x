    ...
    <table class="table table-bordered">
      <thead>
        <tr>
          ...
          <td colspan="1"><?php echo $text_seller_info; ?></td>
          <td colspan="1"></td>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td style="width: 33.3%;"><address>
            ...
            <b><?php echo $text_website; ?></b> <a href="<?php echo $order['store_url']; ?>"><?php echo $order['store_url']; ?></a></td>
             ...
             <b><?php echo $text_seller_name; ?></b> <?php echo $seller_info['firstname'].' '.$seller_info['lastname']; ?><br />
            <b><?php echo $text_email; ?></b> <?php echo $seller_info['email']; ?><br />
