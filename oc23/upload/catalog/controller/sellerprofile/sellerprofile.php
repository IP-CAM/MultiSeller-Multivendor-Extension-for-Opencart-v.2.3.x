...
class Controllersellerprofilesellerprofile extends Controller
{
    ...
    public function index()
    {
        if (!$this->customer->isLogged()) {
            $this->session->data['redirect'] = $this->url->link('sellerprofile/sellerprofile', '', true);
        ...
        if ($this->config->get('config_seller_agree_id')) {
            ...
            if ($information_info) {
                $data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->link('information/information/agree', 'information_id='.$this->config->get('config_seller_agree_id'), true), $information_info['title'], $information_info['title']);
            } else {
                $data['text_agree'] = '';
            }
        } else {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('sellerprofile/sellerprofile', '', true),
        );
        ...
        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('sellerprofile/sellerprofile',  $url, true),
        );
        ...
        $data['sort_name'] = $this->url->link('sellerprofile/sellerprofile',  '&sort=cgd.name'.$url, true);
        $data['sort_sort_order'] = $this->url->link('sellerprofile/sellerprofile',  '&sort=cg.sort_order'.$url, true);
        $data['sort_product_limit'] = $this->url->link('sellerprofile/sellerprofile',  '&sort=cg.product_limit'.$url, true);
        $data['sort_subscription_price'] = $this->url->link('sellerprofile/sellerprofile',  '&sort=cg.subscription_price'.$url, true);
    ...
    public function sellerproduct()
    {
        ...
        $data['edit'] = $this->url->link('sellerproduct/product', '', true);
        ...
        $pagination->limit = 10;
        $pagination->url = $this->url->link('sellerprofile/sellerprofile/sellerproduct', 'seller_id='.$this->request->get['seller_id'].'&page={page}', true);
    ...
    public function history()
    {
        ...
        $pagination->page = $page;
        $pagination->limit = 10;
        $pagination->url = $this->url->link('sellerprofile/sellerprofile/history', '&seller_id='.$this->request->get['seller_id'].'&page={page}', true);
    ...
    public function transaction()
    {
        ...
        $pagination->page = $page;
        $pagination->limit = 10;
        $pagination->url = $this->url->link('sellerprofile/sellerprofile/transaction', '&seller_id='.$this->request->get['seller_id'].'&page={page}', true);
