...
class Controllerbankaccountbankaccount extends Controller {
    ...
    public function index() {
        ...
        if (!$this->customer->isLogged()) {
            $this->session->data['redirect'] = $this->url->link('bankaccount/bankaccount', '', true);
    ...
    public function add()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('bankaccount/bankaccount', '', true));
        }
    ...
    protected function getList()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('bankaccount/bankaccount', '', true),
        );
        ...
        foreach ($results as $result) {
            ...
            $data['bankaccounts'][] = array(
                ...
                'update' => $this->url->link('bankaccount/bankaccount/edit', 'bankaccount_id='.$result['bankaccount_id'], true),
                'delete' => $this->url->link('bankaccount/bankaccount/delete', 'bankaccount_id='.$result['bankaccount_id'], true),
            );
        }

        $data['insert'] = $this->url->link('bankaccount/bankaccount/add', '', true);
    ...
    protected function getForm()
    {
        ...
        if (!isset($this->request->get['bankaccount_id'])) {
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('bankaccount/bankaccount/add', '', true),
            );
        } else {
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('text_edit_bankaccount'),
                'href' => $this->url->link('bankaccount/bankaccount/edit', 'bankaccount_id='.$this->request->get['bankaccount_id'], true),
            );
        }
        ...
        if (!isset($this->request->get['bankaccount_id'])) {
            $data['action'] = $this->url->link('bankaccount/bankaccount/add', '', true);
        } else {
            $data['action'] = $this->url->link('bankaccount/bankaccount/edit', 'bankaccount_id='.$this->request->get['bankaccount_id'], true);
        }
        ...
        $data['back'] = $this->url->link('bankaccount/bankaccount', '', true);
